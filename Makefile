arp_poison: arp_poison.o InitPcap.o GetNetworkInfo.o AttackInfo.o Print.o
	gcc -pthread -o arp_poison arp_poison.o InitPcap.o GetNetworkInfo.o AttackInfo.o Print.o -lpcap
...
clean:
	rm arp_poison arp_poison.o InitPcap.o GetNetworkInfo.o AttackInfo.o Print.o
